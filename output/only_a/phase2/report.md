...
**Run time**: 2026-06-04T16:39:12.157617+00:00  
...
| Chunks blocked (not inserted) | 16 |
| **DBR-A** (poison caught / total poison) | **53.33%** |
...
|-------------|-------|--------|-----|-----------|
| blocker | 10 | 1 | 10% | 0.100 |
| hijack | 10 | 8 | 80% | 0.800 |
...
- Audit log: `output\only_a\phase2\audit_defense_a.jsonl`